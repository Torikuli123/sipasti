...
<head>
    ...
    <title>SIPASTI — Sistem Pengelolaan Arsip</title>
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-brand">
                ...
                <div class="brand-text">
                    <span class="brand-name">SIPASTI</span>
                    <span class="brand-sub">Pencatatan Arsip Statis</span>
                </div>
            </div>
                ...
                <div class="nav-group {{ request()->routeIs('arsip.*') ? 'open' : '' }}">
                    ...
                    <div class="nav-submenu" id="arsipSubmenu">
                        <a href="{{ route('arsip.index') }}"
                            class="nav-subitem {{ request()->routeIs('arsip.index') ? 'active' : '' }}">Lihat Arsip</a>
                        <a href="{{ route('arsip.create') }}"
                            class="nav-subitem {{ request()->routeIs('arsip.create') ? 'active' : '' }}">Tambah
                            Arsip</a>
                    </div>
                </div>
        ...
        <main class="main-content">
            ...
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <h1 class="page-title">Sistem Informasi Pencatatan Arsip Statis Terintegrasi</h1>
                </div>
                ...
                <div class="topbar-right">
                    ...
                    <div class="dropdown-menu-wrapper">
                        ...
                        <div class="dropdown-menu" id="settingsMenu">
                            ...
                            <a href="{{ route('settings.notifications') }}" class="dropdown-link">Pengaturan
                                Notifikasi</a>
                    ...
                    <div class="user-avatar">
                        <img src="https://ui-avatars.com/api/?name={{ auth()->user()->name ?? 'Admin User' }}&background=1a3a5c&color=fff"
                            alt="User">
                        <div class="user-info">
